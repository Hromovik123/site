...
<div>
  <div class="container">
    <div class="introinner"> 
      <h1 class="introtitle">Про нас</h1>
    </div>
  </div>

  <div class="text">
    <h2>
      <p class="abouttext">Цей сайт зроблений для дипломної роботи Нестора Олега. Суть онлайн-кінотеатру - легально переглядати улюблені фільми не виходячи з дому. Половина ціни з купівлі онлайн-квитка йде до творців фільму, завдяки чому цей сайт є легальним.</p>
        <p class="abouttext">Онлайн-кінотеатр запустився в травні 2022 року. Ви вже можете переглянути найпопулярніші фільми останніх років, стару-добру класику, а також, у скорому часі новинки. Можна вибрати до перегляду фільм на будь-який смак, від кінокласики та фільмів-призерів міжнародних кінофестивалів до дебютів молодих режисерів та мистецької документалістики.</p>
    </h2>
  </div>
</div><br>
