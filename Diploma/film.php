...
<div class="img">
    <img src="images/<?= $film_info['main_img'] ?>" width="370px" height="530px" alt="main img">
</div>
<br>
<div class="text">
    <div class="text-1"><b> <?= $film_info['name'] ?> </b></div>
    <h2 class="text-2">
        <b>Рік:</b> <?= $film_info['year'] ?><br>
        <b>Країна:</b> <?= $film_info['country'] ?><br>
        <b>Жанр:</b> <?= $film_info['genre'] ?><br>
        <b>Режисер:</b> <?= $film_info['director'] ?><br>
        <b>Тривалість:</b> <?= $film_info['duration'] ?></h2>
        <?php
            if($_COOKIE['user'] == ''):
        ?>
        <b>Увійдіть в акаунт для купівлі онлайн-квитка!</b>
        <?php else:?>
          <?php
        if($film_info['active'] == 1){
          echo '<a class="btn" href="payment.php?film='.$film_info["id"].'">Купити онлайн-квиток</a>';
          }
        ?>
        <?php endif;?>
</div>
<br>
<div class="text">
    <div class="text-1"><b>Сюжет</b></div>
    <h2 class="text-2"> <?= $film_info['plot_text'] ?> </h2>
</div>
<br><br>
<center> <iframe width="800" height="450" src="https://www.youtube.com/embed/<?= $film_info['ytvideo'] ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </center>
<br><br>
...
<h5 class="widget-title">SITE FOR DIPLOMA<span></span></h5>
<p> Бажаєш дивитися фільми не виходячи з дому? Купуй онлайн-квиток на цьому шикарному сайті!!!</p>
</div>
</div>
...
<ul class="thumbnail-widget">
    <li>
      <div class="thumb-content"><a href="index.php">Головна сторінка</a></div>  
    </li>
    <li>
      <div class="thumb-content"><a href="about.php">Про нас</a></div>  
    </li>
    <li>
      <div class="thumb-content"><a href="timetable.php">Каталог</a></div>  
    </li>
...
<div class="col-xs-12 col-sm-6 col-md-3">
<div class="widget no-box">
<h5 class="widget-title">Приєднуйся до нас<span></span></h5>
    
<a class="btn" href="registration.php">Зареєструватися</a>
  </div>
  </div>
  ...
  <div class="widget no-box">
  <h5 class="widget-title">Зв'язок зі мною<span></span></h5>
    
  <p><a href="mailto:oleh.nestor.knm.2018@lpnu.ua" title="glorythemes">oleh.nestor.knm.2018@lpnu.ua</a></p>
  <p>+38 067 730 0039</p>
  ...
  <p>Site for diploma © 2022. All rights reserved.</p>
  </div>
  </div>
  </div>
  </div>
